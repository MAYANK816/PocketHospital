package com.example.madad.allFragments;
...
import com.example.madad.Adapters.BedAdapter;
...
public class NonICU extends Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_non_i_c_u, container, false);
        recyclerView = v.findViewById(R.id.CovidRecycler);
        databaseReference = FirebaseDatabase.getInstance().getReference("Non ICU");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    user.setHsname("Name: "+dataSnapshot.child("hospitalName").getValue().toString());
